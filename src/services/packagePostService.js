...
module.exports = {
   getAllPackage, setActiveTypePackage,
     creatNewPackagePost, updatePackagePost, getPackageByType,  getPackageById,getPaymentLink, paymentOrderSuccess,getHistoryTrade,getStatisticalPackage, getSumByYear
}