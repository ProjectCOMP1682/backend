                                        ...
                                        <tbody>
                                          <tr>
                                            <td style="width:100px;">
                                              <img height="auto" src="http://res.cloudinary.com/bingo2706/image/upload/v1732884246/dev_setups/sxjcrrsq4qu83toj2lgh.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="100" />
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                  ...
                                  <tr>
                                    <td align="left" style="font-size:0px;padding:0px 0px;word-break:break-word;">
                                      <div style="font-family:SF Pro Display;font-size:16px;line-height:1;text-align:left;color:#000000;">
                                        <p> You get suitable job listings </p>
                                      </div>
                                    </td>
                                  </tr>
                                </tbody>
                    ...
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:SF Pro Display;font-size:16px;font-style:normal;line-height:1;text-align:left;color:#000000;">
                        <div>
                          ...
                          <div>Job Location: ${postInfo.postDetailData.provincePostData.value}</div>
                          <div>Job Type: ${postInfo.postDetailData.workTypePostData.value} </div>
                          <div>Salary: ${postInfo.postDetailData.salaryTypePostData.value}</div>
                        </div>
                      </div>
                    </td>
                  </tr>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                        <tr>
                          <td align="center" bgcolor="red" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:red;" valign="middle">
                            <a href=${process.env.URL_REACT+'/all-jobs'} style="display:inline-block;background:red;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;" target="_blank"> See more jobs </a>
                          </td>
                        </tr>
                      </table>
                    </td>
                      ...
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">
                        <div style="text-align: center">
                          ...
                          <div style="margin-top: 10px">
                            <img src="http://res.cloudinary.com/bingo2706/image/upload/v1732884246/dev_setups/sxjcrrsq4qu83toj2lgh.png"></img>
                          </div>
